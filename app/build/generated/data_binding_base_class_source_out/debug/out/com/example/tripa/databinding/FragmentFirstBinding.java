...
public final class FragmentFirstBinding implements ViewBinding {
  ...
  private FragmentFirstBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView userList) {
  ...
  public static FragmentFirstBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.userList;
      RecyclerView userList = rootView.findViewById(id);
      if (userList == null) {
        break missingId;
      }

      return new FragmentFirstBinding((ConstraintLayout) rootView, userList);
    }
